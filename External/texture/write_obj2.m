function write_obj2(path, filename, vertex, face, options)
...
% vertex normals
if isfield(options, 'vertex_normals')
...
elseif isfield(options, 'vertex_normals')
    face_texcorrd = [face(:,1), face(:,1), face(:,1), face(:,2), face(:,2),face(:,2), face(:,3), face(:,3), face(:,3)];
